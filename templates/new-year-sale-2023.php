<?php
/**
 * Template Name: New Year Sale 2023
 *
 * @author  Sovware
 * @since   1.0
 * @version 1.0
...
<section class="pricing-intro-area position-relative bfcm_pricing-intro new-year-bg deal-sale-intro pt-80 pb-180" style="background-image: url('<?php echo Helper::get_img( 'new-year-sale-bg-2023.png' );?>');background-size: cover;background-position: center bottom;" >
    <div class="container">
        <div class="row">
            <div class="col-12">
					...
					<div class="row product-items-pricing">
						<div class="col-xl-4 col-md-6">
							<div class="product-card theme-bfcm">
								<div class="product-card__offer-badge">
									<img src="<?php echo Helper::get_svg('40-off-badge.svg');?>">
								</div>
						...
						<div class="col-xl-4 col-md-6">
							<div class="product-card theme-bfcm">
								...
								<div class="product-card__bottom d-flex justify-content-between align-items-center">
									<span class="price-info pink"><span class="currency">$</span><span class="price">69</span><span class="text">Starting from</span></span>
