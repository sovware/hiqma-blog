<?php
/**
 * Template Name: Woocomerce Product Carousel Slider Grid Ultimate Pro
 *
 * @author  Sovware
 * @since   1.0
 * @version 1.0
...
<section class="wpwax-signle-product-banner wpwax-single-product-banner-bg page-template">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-7">
                <div class="wpwax-signle-product-banner__text text-center">
                    <h1 class="display-3">Product Carousel Slider and Grid Ultimate Pro for WooCommerce <br> Special
                        Lifetime Deal Offer for <span class="colored-text color-primary">Dowload
                            Silo<?php echo Helper::the_svg( 'icons/emoji' ); ?> </span></h1>
...
<?php get_template_part('template-parts/product-pricing-landing-55', null, [ 'download_id' => $download_id ] ); ?>
