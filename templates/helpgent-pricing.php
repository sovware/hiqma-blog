<?php
/**
 * Template Name: HelpGent - Pricing
 *
 * @author  Sovware
 * @since   1.0
 * @version 1.0
...
<section class="helpgent-banner-area pricing" id="pricing">
    <div class="helpgent-pricing-banner pb-30">
        <div class="container">
            <div class="text-center row align-items-center justify-content-center">
                <div class="col-lg-9">
                    <h1>
                        Make your communication <br> streamlined asynchronously
                    </h1>
                    <p class="text-16">
                        Making Simplicity, Affordability, and Realism Accessible
                    </p>
                </div>
            </div>
        </div>
