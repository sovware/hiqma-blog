<?php
/**
 * Template Name: Eid-Al-Fitr Pricing Page
 *
 * @author  Sovware
 * @since   1.0
 * @version 1.0
...
<section class="pricing-intro-area position-relative bfcm_pricing-intro eid-bg" >
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="pricing-intro-content text-center theme-bfcm theme-ramadan theme-eid">
                    <div class="bfcm-img">
                        <img src="<?php echo Helper::get_svg('eid-intro-img.svg');?>">
                    </div>
                    <!-- Without Deals -->
                    <p class="eid-welcom-text">Celebrate Eid with Your Family & Friends</p>
                    <h2>Get Discounts up to <span class="highlighted">70%</span> for Both Yearly and Lifetime</h2>
