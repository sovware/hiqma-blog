<?php
/**
 * Template Name: Special Pricing Page
 *
 * @author  Sovware
 * @since   1.0
 * @version 1.0
...
<section class="pricing-intro-area position-relative bfcm_pricing-intro special-bg deal-sale-intro" >
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="text-center pricing-intro-content theme-bfcm theme-ramadan">
					...
					<h2>Get Discounts up to <span class="highlighted">25%</span> for Both Yearly and Lifetime</h2>
						...
						<div class="col-xl-4 col-md-6">
							<div class="product-card theme-bfcm">
								...
								<div class="product-card__bottom d-flex justify-content-between align-items-center">
									<span class="price-info pink"><span class="currency">$</span><span class="price">63</span><span class="text">Starting from</span></span>
