...
<section
    class="wpwax-signle-product-banner wpwax-single-product-banner-bg wpwax-single-product-banner-video theme-2 page-template">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="wpwax-signle-product-banner__text text-center">
                    <h1 class="display-2">Legal Pages Pro <br> Special Lifetime Deal Offer for <span
                            class="color-primary">DecisiveMarketer <?php echo Helper::the_svg( 'icons/emoji' ); ?>
                        </span></h1>
                    <span class="wpwax-offer-badge"><?php echo Helper::the_svg( 'icons/offer-badge' ); ?></span>
                    <div class="wpwax-signle-product-banner__button">
                        <a href="#single-plugin-pricing-plan" class="btn btn-raised btn-success">
                            <?php echo wpwax_icon( 'uil uil-shopping-cart', false); ?>Get Now</a>
                    </div>
...
<?php get_template_part('template-parts/product-pricing-landing', null, [ 'download_id' => $download_id ] ); ?>
