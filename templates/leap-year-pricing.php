<?php
/**
 * Template Name: Leap Year Pricing Page
 *
 * @author  Sovware
 * @since   1.0
 * @version 1.0
...
<section class="pricing-intro-area bfcm_pricing-intro leap-year-bg" >
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="text-center pricing-intro-content theme-bfcm theme-leap-year">
                    ...
                    <h2 class="display-3 intro-subtitle">wpWax's Leap Year Event: <br> Catch it while you can, like leap year itself!</h2>
						...
						<div class="col-xl-4 col-md-6">
							<div class="product-card theme-bfcm">
								<div class="product-card__offer-badge">
									<img src="<?php echo Helper::get_svg('29-off-badge.svg');?>">
								</div>
