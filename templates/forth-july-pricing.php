<?php
/**
 * Template Name: Forth July Pricing Page
 *
 * @author  Sovware
 * @since   1.0
 * @version 1.0
...
<section class="pricing-intro-area position-relative bfcm_pricing-intro star-bg" >
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="pricing-intro-content text-center theme-bfcm theme-ramadan theme-forth-july">
                    <div class="memorable-sale-img">
                        <img src="<?php echo Helper::get_svg('4th-july-img.svg');?>">
                    </div>
                    <!-- Without Deals -->
                    <h2>Enjoy up to <span class="highlighted">45%</span> off on plans! </h2>
						...
						<div class="col-xl-4 col-md-6">
							<div class="product-card theme-bfcm">
								<div class="product-card__offer-badge">
									<img src="<?php echo Helper::get_svg('45-off-badge.svg');?>">
								</div>
