<?php
/**
 * Template Name: HelpGent - Ramadan Pricing
 *
 * @author  Sovware
 * @since   1.0
 * @version 1.0
...
<section class="pricing-intro-area position-relative ramadan-bg pt-60 pb-80">
	<div class="container">
		<div class="row">
			<div class="col-12">
                <div class="pricing-intro-content text-center theme-bfcm theme-ramadan">
                    <div class="bfcm-img">
                        <img src="<?php echo Helper::get_svg('ramadan40.svg');?>">
                    </div>
                    
                    <!-- <p class="start-end">The Deal Will End After</p>
                ...
                <div class="faq-accordion" id="accordionExample">
                    ...
                    <div class="faq-accordion__single">
                        ...
                        <div id="faq-body-17" class="faq-single-body collapse" aria-labelledby="question17"
                            data-parent="#accordionExample">
                            <div class="body-inner">
                                <p>All data is securely stored on your WordPress server, granting you full control. Additionally, you have the option to offload media to external cloud storage services such as Google Drive and Bunny Storage.
                                </p>
                            </div>
                        </div>
                    </div>
