...
<section class="pricing-intro-area position-relative">
    <div class="shape banner-shape"><?php echo Helper::the_svg('shapes/pricing-shape'); ?></div>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="pricing-intro-content text-center">
                    <p>Scale Up Your Business with A Smooth WP Experience</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="pricing-body">
                        ...
                        <div class="pricing-plan-box fade show" id="yearly-access">
                            <div class="prcing-plans d-flex justify-content-center">
                                <div class="prcing-plans__single">
                                    <div class="prcing-plans__top">
                                        ...
                                        <span class="pricing-price">
                                            ...
                                            <span class="price-text">139.99</span>
                                    ...
                                    <div class="prcing-plans__list">
                                        <ul class="list-unstyled mb-0 ml-0">
                                            ...
                                            <li><img src="<?php echo Helper::get_svg('icons/check.svg');?>"><span
                                                    class="list-text">WooCommerce Product Carousel Slider Pro</span>
                                            </li>
                                            <li><img src="<?php echo Helper::get_svg('icons/check.svg');?>"><span
                                ...
                                <div class="prcing-plans__single active">
                                    ...
                                    <div class="prcing-plans__top">
                                        ...
                                        <span class="pricing-price">
                                            <span class="currency">$</span>
                                            <span class="price-text">399.99</span>
                                        </span>
                                    </div>
                                    <div class="prcing-plans__list">
                                        <ul class="list-unstyled mb-0 ml-0">
                        ...
                        <shape class="shape shape-bottom"><?php echo Helper::the_svg('shapes/leafs'); ?></shape>
                    </div>
                </div>
            </div>
        </div>
