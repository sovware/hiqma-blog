...
<section class="pricing-intro-area position-relative bfcm_pricing-intro special-bg deal-sale-intro pt-130 pb-180">
	<div class="container">
		<div class="row">
			<div class="col-12">
				<div class="text-center pricing-intro-content theme-bfcm ">
					...
					<h2>Get Discounts up to <span class="highlighted">20%</span> for Both Yearly and Lifetime</h2>
					<!-- <p class="start-end">Offer Will End After</p>
					<div class="offer-countdown mb-lg-0 mb-5">
						...
						<div class="col-xl-4 col-md-6">
							<div class="product-card theme-bfcm">
								<div class="product-card__offer-badge">
									<img src="<?php echo Helper::get_svg('20-off-badge.svg');?>">
								</div>
								<div class="product-card__img">
									<a href="https://directorist.com/pricing/" target="_blank"><img
											src="<?php echo Helper::get_img( 'directorist.png' );?>"></a>
								</div>
								<div class="product-card__top">
									<h5 class="product-title"><a href="<?php echo THEME_DIRECTORIST; ?>"
											target="_blank">Directorist - The Most Complete WordPress Directory
											Plugin</a></h5>
								</div>
								<div class="product-card__bottom d-flex justify-content-between align-items-center">
									<span class="price-info pink"><span class="currency">$</span><span
											class="price">71</span><span class="text">Starting from</span></span>
							...
							<div class="product-card theme-bfcm">
								...
								<div class="product-card__img">
									<a href="https://wpwax.com/helpgent/pricing/"><img
											src="<?php echo Helper::get_img( 'helpgent.png' );?>"></a>
								</div>
								<div class="product-card__top">
									<h5 class="product-title"><a href="<?php echo THEME_HELPGENT; ?>">Helpgent - A
											Better Way to Connect With Your Audiences.</a></h5>
								</div>
								<div class="product-card__bottom d-flex justify-content-between align-items-center">
									<span class="price-info pink"><span class="currency">$</span><span
											class="price">89</span><span class="text">Starting from</span></span>
