<?php
/**
 * Template Name: HelpGent - Leap Year Pricing
 *
 * @author  Sovware
 * @since   1.0
 * @version 1.0
...
<section class="pricing-intro-area position-relative bfcm_pricing-intro leap-year-bg deal-sale-intro pt-60 pb-80">
	<div class="container">
		<div class="row">
			<div class="col-12">
                <div class="text-center pricing-intro-content theme-bfcm theme-leap-year">
                    <div class="memorable-sale-img">
                        <img alt="leap-year-sale-logo" src="<?php echo Helper::get_svg('leap-year-offer.svg');?>">
                    </div>
					<h1 class="display-3 intro-title">Exclusive Once-Every-4-Years Offer!</h1>
                    <h2 class="display-3 intro-subtitle">HelpGent's Leap Year Event: <br> Catch it while you can, like leap year itself!</h2>
