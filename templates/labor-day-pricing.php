<?php
/**
 * Template Name: Labor Day Pricing Page
 *
 * @author  Sovware
 * @since   1.0
 * @version 1.0
...
<section class="pricing-intro-area bfcm_pricing-intro labor-day-bg" >
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="text-center pricing-intro-content theme-bfcm theme-labor">
                    <div class="memorable-sale-img">
                        <img alt="labor-day-sale-logo" src="<?php echo Helper::get_svg('labor-day-sale.svg');?>">
                    </div>
					<h1 class="display-3 intro-title">Elevate Your WordPress Journey with <br>Cutting-Edge Plugins</h1>
