...
<div id="affwp-affiliate-dashboard-wrap">
	...
	<?php if ( 'active' == affwp_get_affiliate_status( affwp_get_affiliate_id() ) ) : ?>
		...
		?>
		<div class="affwp-affiliate-dashboard">
			<ul id="affwp-affiliate-dashboard-tabs" class="affwp-affiliate-dashboard__nav nav">
				<?php
				...
				if ( $tabs ) {
					foreach ( $tabs as $tab_slug => $tab_title ) : ?>
						...
						<li class="affwp-affiliate-dashboard-tab affwp-affiliate-dashboard__item<?php echo $active_tab == $tab_slug ? ' active' : ''; ?>">
				...
				<li class="affwp-affiliate-dashboard-tab affwp-affiliate-dashboard__item">
