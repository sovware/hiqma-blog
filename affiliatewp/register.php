...
<form id="affwp-register-form" class="affwp-form mb-30" action="" method="post">
	<?php
	/**
	...
	<fieldset>
		...
		<div class="form-group">
			...
			<input class="button btn btn-primary" type="submit" value="<?php esc_attr_e( 'Register', 'affiliate-wp' ); ?>" />
		</div>
