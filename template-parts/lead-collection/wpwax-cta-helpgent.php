...
<section class="helpgent-cta">
	<div class="product-cta">
		<img class="product-cta__img" width="398" height="332" src="<?php echo Helper::get_img( 'blog/helpgent-posts.png' );?>" alt="directorist blog post">
