...
?>
<div class="main-header navbar fixed-top navbar-expand-lg p-lg-0">

	<div class="container">
		<div class="site-branding d-flex">
			<a aria-label="wpwax logo" class="logo navbar-brand m-0 p-0"
				href="<?php echo esc_url(home_url('/')); ?>"><?php echo Helper::get_img( 'logo' ); ?></a>
		</div>

		<div class="main-navigation-wrap d-flex align-items-center">
			<div class="main-navigation"><?php wp_nav_menu(Helper::get_nav_menu_args('primary')); ?></div>
