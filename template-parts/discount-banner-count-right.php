...
<div class="sovWare__discount-banner theme-bfcm theme-bfcm-new theme-count-right">
    <div class="container">
        <div class="row">
            <div class="col-12">
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-5">
                            <div class="discount-info-wrap d-flex align-items-center">
                                <img src="<?php echo Helper::get_svg('bfcm-22-top.svg');?>">
                                <!-- <span class="short-text">Year-end MEGA Offer!</span> -->
                            </div>
                        </div>
                        <div class="col-xl-7">
                            <!-- <h5 class="dis-title">up to<span class="off-percentage">50%</span> OFF</h5> -->
