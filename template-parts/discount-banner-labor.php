...
<div class="sovWare__discount-banner theme-bfcm theme-labor-day">
	<div class="container">
		<div class="row">
			<div class="col-12">
            ...
            <div class="col-xl-9">
				<div class="discount-info">
					<div class="discount-info-wrap d-flex align-items-center">
						<img class="performance-check m-w-90" alt="labor-day-sale-logo" src="<?php echo Helper::get_svg('labor-day-sale-logo.svg');?>">
					</div>
					<div class="discount-info-content d-flex">
						<div class="special-banner-text d-flex">
							<h5 class="dis-title"> <span>Save Up To<span class="off-percentage">40%</span> on any purchase</span></h5>
						</div>
