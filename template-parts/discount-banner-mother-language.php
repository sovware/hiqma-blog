...
<div class="sovWare__discount-banner theme-bfcm theme-special theme-mother-language">
	<div class="container">
		<div class="row">
			<div class="col-12">
					...
					<div class="row align-items-center">
						<div class="col-xl-3">
                            <div class="discount-info-wrap d-flex align-items-center">
                                <span class="short-text">International Mother <br> Language Day Sale</span>
                            </div>
						</div>
						<div class="col-xl-9">
                            <div class="discount-info-content d-flex">
                                <div class="special-banner-text d-flex">
                                    <h5 class="dis-title"> <span>Save up to</span> <span class="off-percentage">45%</span></h5>
