...
<div class="pricing-plan-area pt-110 bfcm_pricing-plan single-product-pricing-bg product-pricing-landing"
    id="single-plugin-pricing-plan">
    <div class="container">
        <div class="row">
            <div class="col-12">
                            ...
                            <div class="prcing-plans d-flex">
                                <div class="prcing-plans__single bfcm-pricing-single theme-ramadan">
                                    ...
                                    <div class="prcing-plans__top">
                                        ...
                                        <span class="pricing-price">
                                            <span class="old-price"><del>$119</del></span> <span
                                                class="currency">$</span> <span class="price-text">39</span> </span>
                                    </div>
                                    <div class="prcing-plans__list">
                                        <ul class="mb-0 ml-0 list-unstyled">
                                            <li><img src="<?php echo Helper::get_svg('icons/check.svg');?>"><span
                                                    class="list-text">1 Website License </span></li>

                                            <li><img src="<?php echo Helper::get_svg('icons/check.svg');?>"><span
                                                    class="list-text">Lifetime Updates</span></li>
                                            <li><img src="<?php echo Helper::get_svg('icons/check.svg');?>"><span
                                                    class="list-text">Lifetime Priority Support</span></li>
                                        </ul>
                                    </div>
                                    <div class="prcing-plans__bottom">
                                        <a href="<?php echo Helper::edd_checkout_url($download_id,4, '&discount=LTD1SITE'); ?>"
                                ...
                                <div class="prcing-plans__single bfcm-pricing-single theme-ramadan">
                                    ...
                                    <div class="prcing-plans__top">
                                        <h5>5 Sites</h5>
                                        <span class="pricing-price">
                                            <span class="old-price"><del>$219</del></span> <span
                                                class="currency">$</span> <span class="price-text">79</span> </span>
                                    </div>
                                    <div class="prcing-plans__list">
                                        <ul class="mb-0 ml-0 list-unstyled">
                                            <li><img src="<?php echo Helper::get_svg('icons/check.svg');?>"><span
                                                    class="list-text">5 Websites License </span></li>
                                    ...
                                    <div class="prcing-plans__bottom">
                                        <a href="<?php echo Helper::edd_checkout_url($download_id,5, '&discount=LTD5SITES'); ?>"
                                            class="btn btn-primary btn-md btn-transparent">Buy Now</a>
                                    </div>
                                </div>
                                <div
                                    class="prcing-plans__single bfcm-pricing-single theme-ramadan active pricing-unlimited">
                                    ...
                                    <div class="prcing-plans__top">
                                        ...
                                        <span class="pricing-price">
                                            <span class="old-price"><del>$349</del></span> <span
                                                class="currency">$</span> <span class="price-text">129</span> </span>
                                    </div>
                                    <div class="prcing-plans__list">
                                        <ul class="mb-0 ml-0 list-unstyled">
                                            <li><img src="<?php echo Helper::get_svg('icons/check.svg');?>"><span
                                                    class="list-text">Unlimited Websites License </span></li>
                                    ...
                                    <div class="prcing-plans__bottom">
                                        <a href="<?php echo Helper::edd_checkout_url($download_id,6, '&discount=LTD-Unlimited'); ?>"
