...
?>
<div class="main-header fixed-top navbar navbar-expand-lg navbar-light bg-light p-lg-0">

	<div class="container">
		<div class="site-branding d-flex">
			<a aria-label="wpwax logo" class="logo navbar-brand m-0 p-0"
				href="<?php echo esc_url(home_url('/')); ?>"><?php echo Helper::the_svg( 'logo' ); ?></a>
		</div>

		<div class="main-navigation-wrap d-flex align-items-center collapse navbar-collapse" id="navbarTogglerDemo02">
			<div class="main-navigation navbar-nav mr-auto mt-2 mt-lg-0">
				<?php wp_nav_menu(Helper::get_nav_menu_args('primary')); ?>
			</div>
			<a href="https://wa.link/8ee9xa" target="_blank"
				class="nav-link support-element btn px-3 text-center d-flex align-items-center justify-content-center border">
				...
				<strong>+966559006487</strong>
			</a>

			<div class="header-btn-group">
				<a href="<?php echo THEME_LOGIN_URL;?>" class="btn btn-primary btn-raised btn-sm btn-account">
					<?php echo wpwax_icon( 'uil uil-user', false); ?>Account
				</a>
				<ul>
